...
fun tabComplete(manager: CommandManager, sender: CommandSender, command: Command, args: Array<String>): List<String> {
    val node = manager.commands[command.name] ?: return emptyList()
    val last = args.last()
